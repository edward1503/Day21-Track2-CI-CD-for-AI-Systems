...
![Task 1 - MLflow Run](screenshots/Task1-MlflowRun.png)
...
![Task 2 - Check Eval Gate Fail](screenshots/Task2-CheckEvalGate.png)

Sau khi giảm mức eval gate xuống 0.65 thì pass và deploy thành công lên EC2

*Ảnh chụp toàn cảnh GitHub Actions:*
![Task 2 - GitHub Actions Flow](screenshots/Task2-GithubActionsFlow.png)
...
![Task 2 - EC2 Curl Serve](screenshots/Task2-EC2Curl.png)
...
![Task 3 - Eval Gate Pass](screenshots/Task3-EvalGatePass.png)

*Ảnh chụp Pipeline tự động chạy lại từ đầu đến cuối (Màu xanh):*
![Task 3 - New GitHub Actions](screenshots/Task3-NewActions.png)
...
- **Minh chứng:**
![Bonus 1 - DagsHub Tracking](screenshots/BONUS-1.png)
...
- **Minh chứng:**
![Bonus 2 - Multi Algorithm](screenshots/BONUS-2.png)
...
- **Minh chứng:**
![Bonus 3 - Auto Report](screenshots/BONUS-3.png)
...
- **Minh chứng:**
![Bonus 4 - Rollback Old Version](screenshots/BONUS-4.png)
...
- **Minh chứng:**
![Bonus 5 - Data Drift Warning](screenshots/BONUS-5.png)
